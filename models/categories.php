...
/**
  * JMailUnsubscribe Component Categories Model
  *
  * @package JMailUnsubscribe
  */
  class JMailUnsubscribeModelCategories extends JModel {
  /**
   ...
   */
	...
	function _buildQuery() {
		...
		$aid = $user->get('aid', 0);
		//Query to retrieve all categories that belong under the jmailunsubscribe section and that are published.
		...
		.' LEFT JOIN #__jmailunsubscribe AS a ON a.catid = cc.id'
		.' WHERE a.published = 1'
		.' AND section = \'com_jmailunsubscribe\''
		.' AND cc.published = 1'

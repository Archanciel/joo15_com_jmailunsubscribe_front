...
class JMailUnsubscribeModelCategory extends JModel {
	/**
	 * Category id
	 *
	 * @var int
  ...
  function __construct() {
  	parent::__construct();
		...
		$this->setState('limit', $mainframe->getUserStateFromRequest('com_jmailunsubscribe.limit', 'limit', $config->getValue('config.list_limit'), 'int'));
  ...
  function _loadCategory() {
		if (empty($this->_category)) {
  		// current category info
			...
			' AND c.section = "com_jmailunsubscribe"';

...
/**
  ...
  */
class JMailUnsubscribeViewCategories extends JView {
	function display( $tpl = null) {
  	...
  	if (is_object( $menu )) {
			...
			if (!$menu_params->get( 'page_title')) {
				$params->set('page_title', JText::_( 'COMPONENTTITLE' ));
			}
		} else {
			$params->set('page_title', JText::_( 'COMPONENTTITLE' ));
		}
		...
		if ($params->get('image') != -1) {
  		...
  		$image = JHTML::_('image', 'images/stories/'.$params->get('image'), JText::_('COMPONENTTITLE'), $attribs);
		}
		for($i = 0; $i < count($categories); $i++) {
  		$category =& $categories[$i];
  		$category->link = JRoute::_('index.php?option=com_jmailunsubscribe&view=category&id='. $category->slug);

...
<tr>
	<?php if (!$this->print) : ?>
		...
		<?php echo JHTML::_('icon.print_popup',  $this->category, $this->params, NULL, array('view'=>'category')); ?>
		</td>
		<?php endif; ?>

		<?php if ($this->params->get('show_email_icon')) : ?>
		<td align="right" width="100%" class="buttonheading">
		<?php echo JHTML::_('icon.email',  $this->category, $this->params, NULL, array('view'=>'category')); ?>
		</td>
		<?php endif; ?>
		
	<?php else : ?>
		<td align="right" width="100%" class="buttonheading">
		<?php echo JHTML::_('icon.print_screen',  $this->category, $this->params, NULL, array('view'=>'category')); ?>
		</td>
	<?php endif; ?>
</tr>
</table>

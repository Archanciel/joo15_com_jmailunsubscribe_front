...
<?php endif; ?>
		...
		<tr>
			<td width="10" style="text-align:right;" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>"><?php echo JText::_('Num'); ?></td>
			<td width="90%" height="20" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>"><?php echo JHTML::_('grid.sort', 'jmailunsubscribe', 'title', $this->lists['order_Dir'], $this->lists['order'] ); ?></td>
		...
		<tr class="sectiontableentry<?php echo $item->odd + 1; ?>">
			...
			<td height="20"><?php echo $item->link; ?></td>
			<?php if ( $this->params->get( 'show_hits_cat' ) ) : ?>

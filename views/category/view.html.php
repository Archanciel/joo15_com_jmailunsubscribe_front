...
/**
  ...
  */
class JMailUnsubscribeViewCategory extends JView {
	function display( $tpl = null ) {
		...
		$model =& JModel::getInstance('categories', 'jmailunsubscribemodel');
		...
		$params->def('comp_description', JText::_('COMPONENTTITLE_DESC'));
		// Define image tag attributes
		if (isset( $category->image ) && $category->image != '') {
			$attribs['align'] = $category->image_position;
			$attribs['hspace'] = 6;
			// Use the static HTML library to build the image tag
			$category->image = JHTML::_('image', 'images/stories/'.$category->image, JText::_('COMPONENTTITLE'), $attribs);
		}
		...
		for($i = 0; $i < $count; $i++) {
			$cat =& $categories[$i];
			$cat->link = JRoute::_('index.php?option=com_jmailunsubscribe&view=category&id='. $cat->slug);
		}
